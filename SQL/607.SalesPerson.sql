...
--  and the ID of a company and the city in which the company is located.
+-------------+------+
| Column Name | Type |
+-------------+------+
| order_id    | int  |
...
-- Write an SQL query to report the names of all the salespersons who did not have nay orders
